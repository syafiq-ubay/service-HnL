 ...
 * @author SyafiqUbai
 */
public class dialog_dataOnderdilService extends javax.swing.JDialog {
    ...
    public dialog_dataOnderdilService(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        setColWidht();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialog_dataOnderdilService.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialog_dataOnderdilService dialog = new dialog_dataOnderdilService(new javax.swing.JFrame(), true);
    ...
    private void pilihData(){
        ...
        jo.setHarga_onderdil(Long.valueOf(tbl_data.getModel().getValueAt(row, 7).toString()));
        dispose();
    }
