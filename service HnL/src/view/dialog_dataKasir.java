 ...
 * @author SyafiqUbai
 */
public class dialog_dataKasir extends javax.swing.JDialog {

    int xx, xy;
    private service_kasir servis = new DAO_kasir();
    public table_kasir tblMod = new table_kasir();
    public model_kasir ks = new model_kasir();
    
    public dialog_dataKasir(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialog_dataKasir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialog_dataKasir dialog = new dialog_dataKasir(new javax.swing.JFrame(), true);
    ...
    private void pilihData(){
        ...
        ks.setId_kasir(tbl_data.getModel().getValueAt(row, 1).toString());
        ks.setNama_kasir(tbl_data.getModel().getValueAt(row, 2).toString());
        dispose();
    }
