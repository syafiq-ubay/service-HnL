...
import tableModel.table_mekanik;

/**
 *
 * @author SyafiqUbai
 */
public class mekanik extends javax.swing.JPanel {

    private service_mekanik servis = new DAO_mekanik();
    table_mekanik tblMod = new table_mekanik();
    ...
    private void initComponents() {
        ...
        dataMekanikLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, dataMekanikLayout.createSequentialGroup()
                .addGroup(dataMekanikLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, dataMekanikLayout.createSequentialGroup()
                        .addGap(25, 25, 25)
        ...
        tambahMekanik.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jLabel2.setText("Tambah Data Mekanik");
        ...
        jLabel4.setText("Id Mekanik  :");

        jLabel5.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jLabel5.setText("Nama Mekanik  :");
        ...
        mainPanel.add(tambahMekanik, "card2");
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        if (x.equals("TAMBAH")) {
            ...
            if (index != -1) {
                model_mekanik mod = tblMod.getData(tbl_cont.convertRowIndexToModel(index));
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        if (x.equals("SIMPAN")) {
            if (validasiIn()) {
                ...
                mod.setId_mekanik(kode);
                mod.setNama_mekanik(nama);
                mod.setTelp_mekanik(telp);
                mod.setEmail_mekanik(email);
                mod.setAlamat_mekanik(alamat);
    ...
    private void btn_searchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_searchMouseClicked
        ...
        if (x.equals("Search") || x.trim().equals("")) {
            ...
            List<model_mekanik> list = servis.pencarianData(x);
            tblMod.setData(list);
        }
    ...
    private void loadData() {
        ...
        List<model_mekanik> list = servis.ambilData();
        tblMod.setData(list);
    ...
    private void dataTable() {
        dataMekanik.setVisible(false);
        tambahMekanik.setVisible(true);

        int row = tbl_cont.getSelectedRow();
        jLabel2.setText("Perbarui Data Mekanik");
    ...
    private void pencarian() {
        List<model_mekanik> list = servis.pencarianData(tf_search.getText().toLowerCase());
        tblMod.setData(list);
    }
}
