 ...
 * @author SyafiqUbai
 */
public class barang_customer extends javax.swing.JPanel {

    private service_barangCustomer servis = new DAO_barangCustomer();
    table_barangcus tblMod = new table_barangcus();
    ...
    private void initComponents() {
        ...
        tf_namcus = new javax.swing.JTextField();
        ...
        tf_namcus.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        tf_namcus.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        ...
        tambahBarangLayout.setHorizontalGroup(
            ...
            .addGroup(tambahBarangLayout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addComponent(tf_namcus, javax.swing.GroupLayout.PREFERRED_SIZE, 990, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(tambahBarangLayout.createSequentialGroup()
                .addGap(16, 16, 16)
        ...
        tambahBarangLayout.setVerticalGroup(
            ...
            .addGroup(tambahBarangLayout.createSequentialGroup()
                ...
                .addComponent(jLabel7)
                .addGap(6, 6, 6)
                .addComponent(tf_namcus, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel8)
                .addGap(6, 6, 6)
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        if (x.equals("TAMBAH")) {
            ...
            if (index != -1) {
                model_barangcus mod = tblMod.getData(tbl_cont.convertRowIndexToModel(index));
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        if (x.equals("SIMPAN")) {
            if (validasiIn()) {
                ...
                String namcus = tf_namcus.getText();
                String telp = tf_telp.getText();

                model_barangcus mod = new model_barangcus();

                mod.setKode_barang(kode);
                mod.setType_barang(type);
                mod.setNama_barang(nambar);
                mod.setNama_customer(namcus);
                mod.setTelp_customer(telp);
    ...
    private javax.swing.JTextField tf_namcus;
    ...
    private boolean validasiIn() {
        ...
        if (tf_kode.getText().trim().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "Type Barang tidak boleh kosong");
        } else if (tf_nambar.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Nama Barang tidak boleh kosong");
        } else if (tf_namcus.getText().trim().isEmpty()) {
    ...
    private void dataTable() {
        ...
        cb_type.setSelectedItem(tbl_cont.getModel().getValueAt(row, 2).toString());
        tf_nambar.setText(tbl_cont.getModel().getValueAt(row, 3).toString());
        tf_namcus.setText(tbl_cont.getModel().getValueAt(row, 4).toString());
        tf_telp.setText(tbl_cont.getModel().getValueAt(row, 5).toString());
