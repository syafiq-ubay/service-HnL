 ...
 * @author SyafiqUbai
 */
public class dialog_dataMekanik extends javax.swing.JDialog {

    int xx, xy;
    private service_mekanik servis = new DAO_mekanik();
    public table_mekanik tblMod = new table_mekanik();
    public model_mekanik mk = new model_mekanik();
    
    public dialog_dataMekanik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialog_dataMekanik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialog_dataMekanik dialog = new dialog_dataMekanik(new javax.swing.JFrame(), true);
    ...
    private void pilihData(){
        ...
        mk.setId_mekanik(tbl_data.getModel().getValueAt(row, 1).toString());
        mk.setNama_mekanik(tbl_data.getModel().getValueAt(row, 2).toString());
        dispose();
    }
