...
public class dialog_dataSupplier extends javax.swing.JDialog {
    ...
    public table_supplier tblMod = new table_supplier();
    public model_supplier jo = new model_supplier();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialog_dataSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void pilihData(){
        ...
        jo.setId_supplier(tbl_data.getModel().getValueAt(row, 1).toString());
        jo.setNama_supplier(tbl_data.getModel().getValueAt(row, 2).toString());
        jo.setToko_supplier(tbl_data.getModel().getValueAt(row, 3).toString());
        dispose();
    }
