...
public class dialog_dataJenis extends javax.swing.JDialog {
    ...
    public table_jenisOnderdil tblMod = new table_jenisOnderdil();
    public model_jenisOnderdil jo = new model_jenisOnderdil();
    ...
    public dialog_dataJenis(java.awt.Frame parent, boolean modal) {
        ...
        tbl_jenisOnderdil.setModel(tblMod);
    ...
    private void initComponents() {
        ...
        tbl_jenisOnderdil = new tablecustom.tablez();
        ...
        tbl_jenisOnderdil.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        tbl_jenisOnderdil.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_jenisOnderdilMouseClicked(evt);
            }
        });
        scrollPaneWin111.setViewportView(tbl_jenisOnderdil);
    ...
    private void tbl_jenisOnderdilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_jenisOnderdilMouseClicked
        pilihData();
    }//GEN-LAST:event_tbl_jenisOnderdilMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialog_dataJenis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private tablecustom.tablez tbl_jenisOnderdil;
    ...
    private void pilihData(){
        int row = tbl_jenisOnderdil.getSelectedRow();
        
        jo.setKode_jenis(tbl_jenisOnderdil.getModel().getValueAt(row, 0).toString());
        jo.setType_jenis(tbl_jenisOnderdil.getModel().getValueAt(row, 1).toString());
        jo.setNama_jenis(tbl_jenisOnderdil.getModel().getValueAt(row, 2).toString());
        dispose();
    }
}
