 ...
 * @author SyafiqUbai
 */
public class dialog_dataSupply extends javax.swing.JDialog {

    int xx, xy;
    private service_supply servis = new DAO_supply();
    public table_supply tbl_mdl = new table_supply();
    public model_supply sp = new model_supply();
    public model_supplier spr = new model_supplier();

    public dialog_dataSupply(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        //setBackground(new Color(0,0,0,0));
        tbl_data.setModel(tbl_mdl);
...
//        setColWidht();
    ...
    private void btn_searchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_searchMouseClicked
        ...
        if (x.equals("Search") || x.trim().equals("")) {
            ...
            List<model_supply> list = servis.pencarianData(x);
            tbl_mdl.setData(list);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialog_dataSupply.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialog_dataSupply dialog = new dialog_dataSupply(new javax.swing.JFrame(), true);
    ...
    private void pencarian() {
        List<model_supply> list = servis.pencarianData(tf_search.getText().toLowerCase());
        tbl_mdl.setData(list);
    }
    ...
    private void pilihData() {
        ...
        List<model_supply> list = servis.getByID(tbl_data.getModel().getValueAt(row, 0).toString());
        sp = list.get(0);
        dispose();
    }
