 ...
 * @author SyafiqUbai
 */
public class dialog_dataService extends javax.swing.JDialog {

    int xx, xy;
    private service_service servis = new DAO_service();
    public table_service tbl_mdl = new table_service();
    public model_service sv = new model_service();
//    public model_service spr = new model_service();

    public dialog_dataService(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        setColWidht();
    ...
    private void btn_searchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_searchMouseClicked
        ...
        if (x.equals("Search") || x.trim().equals("")) {
            ...
            List<model_service> list = servis.pencarianData(x);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialog_dataService.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialog_dataService dialog = new dialog_dataService(new javax.swing.JFrame(), true);
    ...
    private void pencarian() {
        List<model_service> list = servis.pencarianData(tf_search.getText().toLowerCase());
        tbl_mdl.setData(list);
    }
    ...
    private void pilihData() {
        ...
        List<model_service> list = servis.getByID(tbl_data.getModel().getValueAt(row, 0).toString());
        sv = list.get(0);
        dispose();
    }
